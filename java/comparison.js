...
function findObjectsByName(data,storedObject){
    ...
    for (var i=0; i< data.length; i++){
        ...
        console.log(storedObject[j].name);
        j++;
    }
    return result;
    console.log(result);
...
//     var filteredObjects = data.filter(function(item){
//         return item.name === storedObject.name;
//     });
...
//     // console.log(productComparisonList.name);
//     console.log(productComparisonList[j].name);
//     j++;
// }
